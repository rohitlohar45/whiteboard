                ...
                <div id='createBoardModal'>
                    ...
                    <div className='flexbox uc cu full vertical'>
                        ...
                        {this.state.BoardType === 'Password' ?
                            <span className='center fullWidth'>Your WhiteBoard will be protected by a password</span> :
                            <span className='center fullWidth'>Your WhiteBoard will be public</span>
                        }
