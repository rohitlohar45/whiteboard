...
// 				msg: 'The owner of this WhiteBoard is not currently online',
// 				status: 'offline'
// 			});
...
// 			io.to(roomID).emit('message', createMessage(socket, 'Now hosting the WhiteBoard', 'JOIN'));
...
// 					msg: 'The owner of this WhiteBoard has disconnected',
// 					status: 'offline'
// 				});
